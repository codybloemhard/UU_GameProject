...
namespace UU_GameProject
{
    ...
    public class Run
    {
        ...
        public Run()
        {
            game = new GameWindow(1000, true, 4096);
            game.SetLoad(Load);
            game.Run();
        }
        ...
        private void Load()
        {
            ...
            game.states.AddState("gameover", gameover);
            game.states.AddState("menu", menu);
            game.states.AddState("options", options);
            game.states.AddState("game", mainGame);
